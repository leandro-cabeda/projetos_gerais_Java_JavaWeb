 ...
 * @author Leandro
 */
@FacesConverter(value="converterFabricante")
public class ConverterFabricante implements Serializable, Converter {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String string) {
        ...
        try{
            return EntityManagerUtil.getEntityManager().find(Fabricante.class,Integer.parseInt(string));
        }catch(Exception e){
            return null;
        }
    }
