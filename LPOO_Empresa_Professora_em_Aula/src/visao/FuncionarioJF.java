 ...
 * @author vanes
 */
public class FuncionarioJF extends javax.swing.JFrame {
    ArrayList<Funcionario> funcionarios = new ArrayList<>();
    DefaultListModel modelo = new DefaultListModel();
    /**
     * Creates new form FuncionarioJF
     */
    public FuncionarioJF() {
        initComponents();
        lstFuncionarios.setModel(modelo);
    }
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        CadastroFuncionario tela = new CadastroFuncionario(this, rootPaneCheckingEnabled);
        tela.setVisible(true);
        
        Funcionario f = tela.getFun();
        funcionarios.add(f);
        modelo.addElement(f);
    ...
    private void btnInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInfoActionPerformed
        Funcionario f = lstFuncionarios.getSelectedValue();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FuncionarioJF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FuncionarioJF().setVisible(true);
            }
        });
    }
