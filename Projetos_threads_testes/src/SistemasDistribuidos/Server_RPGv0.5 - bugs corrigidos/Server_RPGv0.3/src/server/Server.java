...
public class Server {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        try {
            ...
            Item i1 = new Item("Desvio da Merenda Escolar", "Melhora poder de ataque em 15");
            i1.setAtributo(Atributo.ATAQUE, 15.0);
            
            Item i2 = new Item("Compra de Juis e Advogados", "Conseguiu se defender com mais 171 pontos");
            i1.setAtributo(Atributo.DEFESA, 171.0);
            
            Item i3 = new Item("Chegou a Propina", "Ganhou mais vitalidade em 24 pontos");
            i1.setAtributo(Atributo.CURA, 24.0);
            
            //adicionaItens...
            jogo.adicionaItem(i1);
            jogo.adicionaItem(i2);
            jogo.adicionaItem(i3);
