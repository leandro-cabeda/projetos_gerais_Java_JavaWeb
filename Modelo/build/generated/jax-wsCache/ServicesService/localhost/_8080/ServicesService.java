 ...
 * 
 */
@WebServiceClient(name = "ServicesService", targetNamespace = "http://localhost:8080", wsdlLocation = "http://DESKTOP-FO14PNI:8080/Webservice/ServicesService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICESSERVICE_QNAME = new QName("http://localhost:8080", "ServicesService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://DESKTOP-FO14PNI:8080/Webservice/ServicesService?wsdl");
    ...
    public Services getServicesPort() {
        return super.getPort(new QName("http://localhost:8080", "ServicesPort"), Services.class);
    }
    ...
    public Services getServicesPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://localhost:8080", "ServicesPort"), Services.class, features);
    }
